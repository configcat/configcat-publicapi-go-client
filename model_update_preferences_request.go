...
type UpdatePreferencesRequest struct {
	...
	KeyGenerationMode NullableKeyGenerationMode `json:"keyGenerationMode,omitempty"`
...
type _UpdatePreferencesRequest UpdatePreferencesRequest
...
// SetKeyGenerationMode gets a reference to the given NullableKeyGenerationMode and assigns it to the KeyGenerationMode field.
...
func (o *UpdatePreferencesRequest) UnmarshalJSON(data []byte) (err error) {
	varUpdatePreferencesRequest := _UpdatePreferencesRequest{}

	err = json.Unmarshal(data, &varUpdatePreferencesRequest)

	if err != nil {
		return err
	}

	*o = UpdatePreferencesRequest(varUpdatePreferencesRequest)
