...
// checks if the UpdateTagModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateTagModel{}
...
type _UpdateTagModel UpdateTagModel
...
func (o *UpdateTagModel) UnmarshalJSON(data []byte) (err error) {
	varUpdateTagModel := _UpdateTagModel{}

	err = json.Unmarshal(data, &varUpdateTagModel)

	if err != nil {
		return err
	}

	*o = UpdateTagModel(varUpdateTagModel)
...
type NullableUpdateTagModel struct {
	value *UpdateTagModel
	isSet bool
}

func (v NullableUpdateTagModel) Get() *UpdateTagModel {
	return v.value
}

func (v *NullableUpdateTagModel) Set(val *UpdateTagModel) {
	v.value = val
	v.isSet = true
}
...
func NewNullableUpdateTagModel(val *UpdateTagModel) *NullableUpdateTagModel {
	return &NullableUpdateTagModel{value: val, isSet: true}
}
