...
// EnvironmentAccessType the model 'EnvironmentAccessType'
...
func (v *EnvironmentAccessType) UnmarshalJSON(src []byte) error {
	...
	enumTypeValue := EnvironmentAccessType(value)
	for _, existing := range AllowedEnvironmentAccessTypeEnumValues {
	...
	return fmt.Errorf("%+v is not a valid EnvironmentAccessType", value)
}

// NewEnvironmentAccessTypeFromValue returns a pointer to a valid EnvironmentAccessType
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewEnvironmentAccessTypeFromValue(v string) (*EnvironmentAccessType, error) {
	ev := EnvironmentAccessType(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for EnvironmentAccessType: valid values are %v", v, AllowedEnvironmentAccessTypeEnumValues)
	}
}
...
func (v EnvironmentAccessType) Ptr() *EnvironmentAccessType {
	return &v
}

type NullableEnvironmentAccessType struct {
	value *EnvironmentAccessType
	isSet bool
}

func (v NullableEnvironmentAccessType) Get() *EnvironmentAccessType {
	return v.value
}

func (v *NullableEnvironmentAccessType) Set(val *EnvironmentAccessType) {
	v.value = val
	v.isSet = true
}

func (v NullableEnvironmentAccessType) IsSet() bool {
	return v.isSet
}
...
func NewNullableEnvironmentAccessType(val *EnvironmentAccessType) *NullableEnvironmentAccessType {
	return &NullableEnvironmentAccessType{value: val, isSet: true}
}
