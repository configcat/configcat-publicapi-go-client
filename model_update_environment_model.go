...
type _UpdateEnvironmentModel UpdateEnvironmentModel
...
func (o *UpdateEnvironmentModel) UnmarshalJSON(data []byte) (err error) {
	varUpdateEnvironmentModel := _UpdateEnvironmentModel{}

	err = json.Unmarshal(data, &varUpdateEnvironmentModel)

	if err != nil {
		return err
	}

	*o = UpdateEnvironmentModel(varUpdateEnvironmentModel)
