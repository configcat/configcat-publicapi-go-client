...
// checks if the ConfigSettingFormulasModelHaljsonEmbedded type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConfigSettingFormulasModelHaljsonEmbedded{}
...
func NewConfigSettingFormulasModelHaljsonEmbedded() *ConfigSettingFormulasModelHaljsonEmbedded {
	this := ConfigSettingFormulasModelHaljsonEmbedded{}
	return &this
}
...
func (o ConfigSettingFormulasModelHaljsonEmbedded) MarshalJSON() ([]byte, error) {
...
type NullableConfigSettingFormulasModelHaljsonEmbedded struct {
	value *ConfigSettingFormulasModelHaljsonEmbedded
	isSet bool
}

func (v NullableConfigSettingFormulasModelHaljsonEmbedded) Get() *ConfigSettingFormulasModelHaljsonEmbedded {
	return v.value
}

func (v *NullableConfigSettingFormulasModelHaljsonEmbedded) Set(val *ConfigSettingFormulasModelHaljsonEmbedded) {
	v.value = val
	v.isSet = true
}

func (v NullableConfigSettingFormulasModelHaljsonEmbedded) IsSet() bool {
	return v.isSet
}

func (v *NullableConfigSettingFormulasModelHaljsonEmbedded) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfigSettingFormulasModelHaljsonEmbedded(val *ConfigSettingFormulasModelHaljsonEmbedded) *NullableConfigSettingFormulasModelHaljsonEmbedded {
	return &NullableConfigSettingFormulasModelHaljsonEmbedded{value: val, isSet: true}
}

func (v NullableConfigSettingFormulasModelHaljsonEmbedded) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfigSettingFormulasModelHaljsonEmbedded) UnmarshalJSON(src []byte) error {
	v.isSet = true
