...
// checks if the ConfigModelHaljsonEmbeddedProductEmbedded type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConfigModelHaljsonEmbeddedProductEmbedded{}
...
func NewConfigModelHaljsonEmbeddedProductEmbedded() *ConfigModelHaljsonEmbeddedProductEmbedded {
	this := ConfigModelHaljsonEmbeddedProductEmbedded{}
	return &this
}
...
func (o *ConfigModelHaljsonEmbeddedProductEmbedded) GetOrganization() ConfigModelHaljsonEmbeddedProductEmbeddedOrganization {
	if o == nil || IsNil(o.Organization) {
		var ret ConfigModelHaljsonEmbeddedProductEmbeddedOrganization
		return ret
	}
...
func (o ConfigModelHaljsonEmbeddedProductEmbedded) MarshalJSON() ([]byte, error) {
...
type NullableConfigModelHaljsonEmbeddedProductEmbedded struct {
	value *ConfigModelHaljsonEmbeddedProductEmbedded
	isSet bool
}

func (v NullableConfigModelHaljsonEmbeddedProductEmbedded) Get() *ConfigModelHaljsonEmbeddedProductEmbedded {
	return v.value
}

func (v *NullableConfigModelHaljsonEmbeddedProductEmbedded) Set(val *ConfigModelHaljsonEmbeddedProductEmbedded) {
	v.value = val
	v.isSet = true
}

func (v NullableConfigModelHaljsonEmbeddedProductEmbedded) IsSet() bool {
	return v.isSet
}

func (v *NullableConfigModelHaljsonEmbeddedProductEmbedded) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfigModelHaljsonEmbeddedProductEmbedded(val *ConfigModelHaljsonEmbeddedProductEmbedded) *NullableConfigModelHaljsonEmbeddedProductEmbedded {
	return &NullableConfigModelHaljsonEmbeddedProductEmbedded{value: val, isSet: true}
}

func (v NullableConfigModelHaljsonEmbeddedProductEmbedded) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfigModelHaljsonEmbeddedProductEmbedded) UnmarshalJSON(src []byte) error {
	v.isSet = true
