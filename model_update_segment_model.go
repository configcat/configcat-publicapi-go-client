...
type _UpdateSegmentModel UpdateSegmentModel
...
func (o *UpdateSegmentModel) UnmarshalJSON(data []byte) (err error) {
	varUpdateSegmentModel := _UpdateSegmentModel{}

	err = json.Unmarshal(data, &varUpdateSegmentModel)

	if err != nil {
		return err
	}

	*o = UpdateSegmentModel(varUpdateSegmentModel)
