...
type _UpdateConfigRequest UpdateConfigRequest
...
func (o *UpdateConfigRequest) UnmarshalJSON(data []byte) (err error) {
	varUpdateConfigRequest := _UpdateConfigRequest{}

	err = json.Unmarshal(data, &varUpdateConfigRequest)

	if err != nil {
		return err
	}

	*o = UpdateConfigRequest(varUpdateConfigRequest)
