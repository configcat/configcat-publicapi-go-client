...
func (a *TagsAPIService) CreateTagExecute(r TagsAPICreateTagRequest) (*TagModel, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/products/{productId}/tags"
	...
	if r.createTagModel == nil {
		return localVarReturnValue, nil, reportError("createTagModel is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createTagModel
...
func (a *TagsAPIService) GetSettingsByTagExecute(r TagsAPIGetSettingsByTagRequest) ([]SettingModel, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/tags/{tagId}/settings"
	localVarPath = strings.Replace(localVarPath, "{"+"tagId"+"}", url.PathEscape(parameterValueToString(r.tagId, "tagId")), -1)
...
func (a *TagsAPIService) UpdateTagExecute(r TagsAPIUpdateTagRequest) (*TagModel, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.updateTagModel == nil {
		return localVarReturnValue, nil, reportError("updateTagModel is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.updateTagModel
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
