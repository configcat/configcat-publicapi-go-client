...
type _UpdateMemberPermissionsRequest UpdateMemberPermissionsRequest
...
func (o *UpdateMemberPermissionsRequest) UnmarshalJSON(data []byte) (err error) {
	varUpdateMemberPermissionsRequest := _UpdateMemberPermissionsRequest{}

	err = json.Unmarshal(data, &varUpdateMemberPermissionsRequest)

	if err != nil {
		return err
	}

	*o = UpdateMemberPermissionsRequest(varUpdateMemberPermissionsRequest)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "permissionGroupIds")
		delete(additionalProperties, "isAdmin")
		delete(additionalProperties, "isBillingManager")
		delete(additionalProperties, "removeFromPermissionGroupsWhereIdNotSet")
