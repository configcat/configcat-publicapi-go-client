...
// checks if the UpdateValueModel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateValueModel{}

// UpdateValueModel Represents the value of a Feature Flag or Setting.
type UpdateValueModel struct {
...
func (o *UpdateValueModel) SetBoolValueNil() {
	o.BoolValue.Set(nil)
}
...
func (o *UpdateValueModel) SetStringValueNil() {
...
func (o *UpdateValueModel) SetIntValueNil() {
	o.IntValue.Set(nil)
}
...
func (o *UpdateValueModel) SetDoubleValueNil() {
...
func (o UpdateValueModel) ToMap() (map[string]interface{}, error) {
...
func (v NullableUpdateValueModel) Get() *UpdateValueModel {
	return v.value
}

func (v *NullableUpdateValueModel) Set(val *UpdateValueModel) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateValueModel) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateValueModel) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateValueModel(val *UpdateValueModel) *NullableUpdateValueModel {
	return &NullableUpdateValueModel{value: val, isSet: true}
}

func (v NullableUpdateValueModel) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateValueModel) UnmarshalJSON(src []byte) error {
	v.isSet = true
