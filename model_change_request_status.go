...
// ChangeRequestStatus The lifecycle status of a Change Request.
type ChangeRequestStatus string

// List of ChangeRequestStatus
const (
	CHANGEREQUESTSTATUS_OPEN ChangeRequestStatus = "open"
	CHANGEREQUESTSTATUS_APPLIED ChangeRequestStatus = "applied"
	CHANGEREQUESTSTATUS_CLOSED ChangeRequestStatus = "closed"
)
