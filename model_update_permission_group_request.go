...
type _UpdatePermissionGroupRequest UpdatePermissionGroupRequest
...
func (o *UpdatePermissionGroupRequest) UnmarshalJSON(data []byte) (err error) {
	varUpdatePermissionGroupRequest := _UpdatePermissionGroupRequest{}

	err = json.Unmarshal(data, &varUpdatePermissionGroupRequest)

	if err != nil {
		return err
	}

	*o = UpdatePermissionGroupRequest(varUpdatePermissionGroupRequest)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "name")
		delete(additionalProperties, "canManageMembers")
		delete(additionalProperties, "canCreateOrUpdateConfig")
		delete(additionalProperties, "canDeleteConfig")
		delete(additionalProperties, "canCreateOrUpdateEnvironment")
		delete(additionalProperties, "canDeleteEnvironment")
		delete(additionalProperties, "canCreateOrUpdateSetting")
		delete(additionalProperties, "canTagSetting")
		delete(additionalProperties, "canDeleteSetting")
		delete(additionalProperties, "canCreateOrUpdateTag")
		delete(additionalProperties, "canDeleteTag")
		delete(additionalProperties, "canManageWebhook")
		delete(additionalProperties, "canUseExportImport")
		delete(additionalProperties, "canManageProductPreferences")
		delete(additionalProperties, "canManageIntegrations")
		delete(additionalProperties, "canViewSdkKey")
		delete(additionalProperties, "canRotateSdkKey")
		delete(additionalProperties, "canCreateOrUpdateSegments")
		delete(additionalProperties, "canDeleteSegments")
		delete(additionalProperties, "canViewProductAuditLog")
		delete(additionalProperties, "canViewProductStatistics")
