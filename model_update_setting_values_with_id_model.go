...
type _UpdateSettingValuesWithIdModel UpdateSettingValuesWithIdModel
...
func (o *UpdateSettingValuesWithIdModel) UnmarshalJSON(data []byte) (err error) {
	varUpdateSettingValuesWithIdModel := _UpdateSettingValuesWithIdModel{}

	err = json.Unmarshal(data, &varUpdateSettingValuesWithIdModel)

	if err != nil {
		return err
	}

	*o = UpdateSettingValuesWithIdModel(varUpdateSettingValuesWithIdModel)
