...
type _CreateOrUpdateEnvironmentAccessModel CreateOrUpdateEnvironmentAccessModel
...
func (o *CreateOrUpdateEnvironmentAccessModel) UnmarshalJSON(data []byte) (err error) {
	varCreateOrUpdateEnvironmentAccessModel := _CreateOrUpdateEnvironmentAccessModel{}

	err = json.Unmarshal(data, &varCreateOrUpdateEnvironmentAccessModel)

	if err != nil {
		return err
	}

	*o = CreateOrUpdateEnvironmentAccessModel(varCreateOrUpdateEnvironmentAccessModel)
