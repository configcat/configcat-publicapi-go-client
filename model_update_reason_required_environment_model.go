...
type _UpdateReasonRequiredEnvironmentModel UpdateReasonRequiredEnvironmentModel
...
func (o *UpdateReasonRequiredEnvironmentModel) UnmarshalJSON(data []byte) (err error) {
	varUpdateReasonRequiredEnvironmentModel := _UpdateReasonRequiredEnvironmentModel{}

	err = json.Unmarshal(data, &varUpdateReasonRequiredEnvironmentModel)

	if err != nil {
		return err
	}

	*o = UpdateReasonRequiredEnvironmentModel(varUpdateReasonRequiredEnvironmentModel)
