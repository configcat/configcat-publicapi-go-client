...
@return SettingModel
*/
func (a *FeatureFlagsSettingsApiService) CreateSetting(ctx context.Context, body CreateSettingInitialValues, configId string) (SettingModel, *http.Response, error) {
	var (
...
@return SettingModel
*/
func (a *FeatureFlagsSettingsApiService) UpdateSetting(ctx context.Context, body JsonPatch, settingId int32) (SettingModel, *http.Response, error) {
	var (
