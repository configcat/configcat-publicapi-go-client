...
type FeatureFlagsSettingsAPIGetPredefinedVariationsRequest struct {
	ctx context.Context
	ApiService *FeatureFlagsSettingsAPIService
	settingId int32
}

func (r FeatureFlagsSettingsAPIGetPredefinedVariationsRequest) Execute() (*PredefinedVariationsWithUsagesModel, *http.Response, error) {
	return r.ApiService.GetPredefinedVariationsExecute(r)
}
...
This endpoint returns the predefined variations along with their usages in the Environments for a Feature Flag or Setting identified by the `settingId` parameter.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param settingId The identifier of the Setting.
 @return FeatureFlagsSettingsAPIGetPredefinedVariationsRequest
*/
func (a *FeatureFlagsSettingsAPIService) GetPredefinedVariations(ctx context.Context, settingId int32) FeatureFlagsSettingsAPIGetPredefinedVariationsRequest {
	return FeatureFlagsSettingsAPIGetPredefinedVariationsRequest{
		ApiService: a,
		ctx: ctx,
		settingId: settingId,
...
func (a *FeatureFlagsSettingsAPIService) GetPredefinedVariationsExecute(r FeatureFlagsSettingsAPIGetPredefinedVariationsRequest) (*PredefinedVariationsWithUsagesModel, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PredefinedVariationsWithUsagesModel
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FeatureFlagsSettingsAPIService.GetPredefinedVariations")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/settings/{settingId}/predefined-variations"
	localVarPath = strings.Replace(localVarPath, "{"+"settingId"+"}", url.PathEscape(parameterValueToString(r.settingId, "settingId")), -1)
...
type FeatureFlagsSettingsAPIUpdatePredefinedVariationsRequest struct {
	ctx context.Context
	ApiService *FeatureFlagsSettingsAPIService
	settingId int32
...
func (r FeatureFlagsSettingsAPIUpdatePredefinedVariationsRequest) UpdatePredefinedVariationsRequest(updatePredefinedVariationsRequest UpdatePredefinedVariationsRequest) FeatureFlagsSettingsAPIUpdatePredefinedVariationsRequest {
	r.updatePredefinedVariationsRequest = &updatePredefinedVariationsRequest
	return r
}
...
**Important:** You can only update a predefined variation's value if it is not used anywhere in your feature flags.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param settingId The identifier of the Setting.
 @return FeatureFlagsSettingsAPIUpdatePredefinedVariationsRequest
*/
func (a *FeatureFlagsSettingsAPIService) UpdatePredefinedVariations(ctx context.Context, settingId int32) FeatureFlagsSettingsAPIUpdatePredefinedVariationsRequest {
	return FeatureFlagsSettingsAPIUpdatePredefinedVariationsRequest{
		ApiService: a,
		ctx: ctx,
		settingId: settingId,
...
func (a *FeatureFlagsSettingsAPIService) UpdatePredefinedVariationsExecute(r FeatureFlagsSettingsAPIUpdatePredefinedVariationsRequest) (*PredefinedVariationsModel, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.updatePredefinedVariationsRequest == nil {
		return localVarReturnValue, nil, reportError("updatePredefinedVariationsRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.updatePredefinedVariationsRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
