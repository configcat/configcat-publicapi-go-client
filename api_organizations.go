...
type OrganizationsAPIGetOrganizationLimitationsRequest struct {
	ctx context.Context
	ApiService *OrganizationsAPIService
	organizationId string
}

func (r OrganizationsAPIGetOrganizationLimitationsRequest) Execute() (*OrganizationLimitations, *http.Response, error) {
	return r.ApiService.GetOrganizationLimitationsExecute(r)
}

/*
GetOrganizationLimitations Get Organization limitations
...
This endpoint returns the limitations of an Organization identified by the `organizationId`.
 ...
 @return OrganizationsAPIGetOrganizationLimitationsRequest
*/
func (a *OrganizationsAPIService) GetOrganizationLimitations(ctx context.Context, organizationId string) OrganizationsAPIGetOrganizationLimitationsRequest {
	return OrganizationsAPIGetOrganizationLimitationsRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *OrganizationsAPIService) GetOrganizationLimitationsExecute(r OrganizationsAPIGetOrganizationLimitationsRequest) (*OrganizationLimitations, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *OrganizationLimitations
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrganizationsAPIService.GetOrganizationLimitations")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/organizations/{organizationId}/organization-limitations"
