...
type _UpdateEvaluationFormulasModel UpdateEvaluationFormulasModel
...
func (o *UpdateEvaluationFormulasModel) UnmarshalJSON(data []byte) (err error) {
	varUpdateEvaluationFormulasModel := _UpdateEvaluationFormulasModel{}

	err = json.Unmarshal(data, &varUpdateEvaluationFormulasModel)

	if err != nil {
		return err
	}

	*o = UpdateEvaluationFormulasModel(varUpdateEvaluationFormulasModel)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "updateFormulas")
