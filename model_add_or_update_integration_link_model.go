...
type _AddOrUpdateIntegrationLinkModel AddOrUpdateIntegrationLinkModel
...
func (o *AddOrUpdateIntegrationLinkModel) UnmarshalJSON(data []byte) (err error) {
	varAddOrUpdateIntegrationLinkModel := _AddOrUpdateIntegrationLinkModel{}

	err = json.Unmarshal(data, &varAddOrUpdateIntegrationLinkModel)

	if err != nil {
		return err
	}

	*o = AddOrUpdateIntegrationLinkModel(varAddOrUpdateIntegrationLinkModel)
