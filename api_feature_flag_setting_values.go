...
/*
FeatureFlagSettingValuesApiService Post values
 ...
 * @param configId The identifier of the Config.
 * @param environmentId The identifier of the Environment.
 * @param optional nil or *FeatureFlagSettingValuesApiPostSettingValuesOpts - Optional Parameters:
...
type FeatureFlagSettingValuesApiPostSettingValuesOpts struct {
    Reason optional.String
}

func (a *FeatureFlagSettingValuesApiService) PostSettingValues(ctx context.Context, body UpdateSettingValuesWithIdModel, configId string, environmentId string, localVarOptionals *FeatureFlagSettingValuesApiPostSettingValuesOpts) (ConfigSettingValuesModel, *http.Response, error) {
	var (
...
func (a *FeatureFlagSettingValuesApiService) UpdateSettingValue(ctx context.Context, body JsonPatch, environmentId string, settingId int32, localVarOptionals *FeatureFlagSettingValuesApiUpdateSettingValueOpts) (SettingValueModel, *http.Response, error) {
	var (
