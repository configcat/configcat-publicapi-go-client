...
// checks if the EnvironmentModelHaljson type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnvironmentModelHaljson{}
...
type NullableEnvironmentModelHaljson struct {
	value *EnvironmentModelHaljson
	isSet bool
}

func (v NullableEnvironmentModelHaljson) Get() *EnvironmentModelHaljson {
	return v.value
}

func (v *NullableEnvironmentModelHaljson) Set(val *EnvironmentModelHaljson) {
	v.value = val
	v.isSet = true
}

func (v NullableEnvironmentModelHaljson) IsSet() bool {
	return v.isSet
}

func (v *NullableEnvironmentModelHaljson) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnvironmentModelHaljson(val *EnvironmentModelHaljson) *NullableEnvironmentModelHaljson {
	return &NullableEnvironmentModelHaljson{value: val, isSet: true}
}
